...
// const nambers1 = [1, 2, 3, 4, 5].every(value => value >= 0); // true

// // Усі елементи більші або дорівнюють нулю? - ні
// const namber2 = [1, 2, 3, -10, 4, 5].every(value => value >= 0); // false

// console.log(nambers1, namber2)
...
// const num = [1, 2, 3, 4, 5].some(value => value >= 0); // true
// console.log(num)
...
// Наприклад, у нас є масив об'єктів фруктів, необхідно дізнатися, чи є фрукти в
// наявності та чи є в наявності хоча б якісь фрукти, тобто більше 0 штук.
