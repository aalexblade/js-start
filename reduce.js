...
// кожного елемента масиву із збереженням проміжного результату, як акумулятор. Трохи складніший за інші методи для засвоєння, але результат вартий того.
...
// ===============================================================
// Помітили властивість tags у кожного поста? Продовжуючи тему reduce,
// ми зберемо в масив усі теги, які зустрічаються в постах.
